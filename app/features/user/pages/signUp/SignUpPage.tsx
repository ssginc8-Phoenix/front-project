...
const Logo = styled.img`
  ...
  max-width: 100%; /* 이미지가 부모 너비를 초과하지 않도록 설정 */
  height: auto; /* 비율 유지를 위해 높이를 자동으로 설정 */
...
const CardGroup = styled.div`
  ...
  ${media.mobile} {
    ...
    max-width: 300px; /* 모바일에서 카드 그룹의 최대 너비 설정 (카드 1개 너비) */
  }

  ${media.mobileSmall} {
    gap: 0.8rem; /* 아주 작은 모바일에서 간격 더 줄임 */
    max-width: 260px; /* 아주 작은 모바일에서 최대 너비 */
  }
`;
